...
if __name__ == "__main__":
    ...
    ensure_dir(args.log_dir_IQA3)

    log_dir = '{}/{}'.format(args.log_dir_IQA3, 'tf')

    ensure_dir(log_dir)

    shutil.copy2(__file__, os.path.join(args.log_dir_IQA3, "script.py"))  # copy2:复制文件和状态到后一个文件  print(__file__)   打印所执行文件当前的位置路径
    ...
    fh = logging.FileHandler(os.path.join(args.log_dir_IQA3, "log_train.txt"))
